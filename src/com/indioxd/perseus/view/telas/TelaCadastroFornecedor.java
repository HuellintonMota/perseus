...
public class TelaCadastroFornecedor extends javax.swing.JFrame {
    ...
    public TelaCadastroFornecedor(int modo) {
        initComponents();
        this.modo = modo;
        prepareMask();
    }
    public TelaCadastroFornecedor(int modo, PessoaEntity fornecedor) {
        initComponents();
        this.modo = modo;
    ...
    public void carregaFornecedorPorID(Long codigoFornecedor){
    
    PessoaEntity f = null;
        try {
            f = new FornecedorService().buscarFornecedorPorID(codigoFornecedor);
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if(txtID.getText().equals("")){
            ...
            try {
                JOptionPane.showMessageDialog(rootPane, fs.salvarFornecedor(f));
            ...
            f.setCodigo(fornecedor.getCodigo());
            try {
            JOptionPane.showMessageDialog(rootPane, fs.atualizaFornecedor(f));
            } catch (NegocioException ex) {
